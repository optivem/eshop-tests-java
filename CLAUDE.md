...
- **Acceptance tests** go in `system-test/src/test/java/com/optivem/eshop/systemtest/mod10/acceptance/`
- **Contract tests** go in `system-test/src/test/java/com/optivem/eshop/systemtest/mod11/contract/<system>/` (e.g. `erp/`, `tax/`, `clock/`)
- Do **NOT** use mod02–mod09 directories for new acceptance/contract tests.
...
Key rules:
- Extend `BaseAcceptanceTest` (in `mod10/acceptance/base/`)
...
- Contract tests extend `BaseExternalSystemContractTest` (in `mod11/contract/base/`)
